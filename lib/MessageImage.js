    ...
    render() {
        ...
        if (!!currentMessage) {
          ...
          <Lightbox activeProps={{
            ...
            {ImageComponent ? (<ImageComponent {...imageProps} style={[styles.image, imageStyle]} source={{ uri: currentMessage.image }}/>) : (<Image {...imageProps} style={[styles.image, imageStyle]} source={{ uri: currentMessage.image }}/>)}
          </Lightbox>
        </View>);
        }
        return null;
